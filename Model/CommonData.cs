...
//			}
		...
		public List<HPData> GetHealthProfessionals () {
			...
			data.Add (new HPData { Id = 5, DisplayName = "MyHealth Media", DisplayIcon = Resource.Drawable.videos });
...
//			};
		...
		public async Task<List<County>> GetCountries () {
//			var data = new List<String> ();
//				data.Add ("Leinster");
//				data.Add ("Ulster");
//				data.Add ("Munster");
//				data.Add ("Connacht");
//			return data;
			var countyList = await MyHealthDB.DatabaseManager.SelectAllCounties ();
