		...
		public static async Task<string> BuildHtmlForDisease(int diseaseId) {
			...
			if (selectedDisease != null) {
				...
				if (!string.IsNullOrEmpty (selectedDisease.SignAndSymptoms))
					htmlString.AppendFormat ("<br/><p style='color:#E11937;'><strong>Signs and Symptoms</strong></p> <div>{0}</div> ", selectedDisease.SignAndSymptoms);
